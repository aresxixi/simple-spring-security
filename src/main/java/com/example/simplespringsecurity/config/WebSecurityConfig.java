    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.oauth2Login(configurer -> {
            configurer
                    .loginPage("")
                    .loginProcessingUrl("")
                    .tokenEndpoint().accessTokenResponseClient(new DefaultAuthorizationCodeTokenResponseClient()).and()
                    .redirectionEndpoint().baseUri("").and()
                    .authorizationEndpoint()
                        .authorizationRequestRepository(new HttpSessionOAuth2AuthorizationRequestRepository())
                        .authorizationRequestResolver(new DefaultOAuth2AuthorizationRequestResolver(null, "")).baseUri("")
                        .and()
                    .userInfoEndpoint()
                        .userAuthoritiesMapper(new NullAuthoritiesMapper())
                        .oidcUserService(new OidcUserService())
                        .userService(new DefaultOAuth2UserService()).and()
